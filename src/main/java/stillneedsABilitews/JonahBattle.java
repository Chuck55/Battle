...
public class JonahBattle implements BattleBase {
    ...
    public boolean Jonahfight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void JonahAttack(MainCharacter newPastor, Monster mon, int count) {
