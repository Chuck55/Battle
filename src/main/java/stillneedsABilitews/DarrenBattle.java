...
public class DarrenBattle implements BattleBase {
    ...
    public boolean Darrenfight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void DarrenAttack(MainCharacter newPastor, Monster mon) {
