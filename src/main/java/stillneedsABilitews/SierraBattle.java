...
public class SierraBattle implements BattleBase {
    ...
    public boolean Sierrafight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void SierraAttack(MainCharacter newPastor, Monster mon, int count) {
