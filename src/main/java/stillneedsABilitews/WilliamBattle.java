...
public class WilliamBattle implements BattleBase {
    private SaveGame saveGame;
    int count = 0;

    public WilliamBattle() {
        saveGame = new SaveGame();
    }

    public boolean Williamfight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
        ...
        scanner.close();
        if (!defeated.williamDefeated) {
            System.out.println("What noobs");
            System.out.println("Narrator : You were defeated");
        }
        return false;
    }

    public void WilliamAttack(MainCharacter newPastor, Monster mon, int count) {
