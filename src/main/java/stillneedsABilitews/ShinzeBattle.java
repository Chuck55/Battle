...
public class ShinzeBattle implements BattleBase {
    ...
    public boolean Shinzefight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void ShinzeAttack(MainCharacter newPastor, Monster mon, int count) {
