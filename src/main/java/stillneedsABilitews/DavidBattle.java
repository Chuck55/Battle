...
public class DavidBattle implements BattleBase {
    ...
    public boolean Davidfight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void DavidAttack(MainCharacter newPastor, Monster mon, int count) {
