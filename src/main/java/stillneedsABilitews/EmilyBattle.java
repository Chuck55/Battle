...
public class EmilyBattle implements BattleBase {
    ...
    public boolean Emilyfight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void EmilyAttack(MainCharacter newPastor, Monster mon, int count) {
