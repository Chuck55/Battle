...
public class SarahBattle implements BattleBase {
    ...
    public boolean Sarahfight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void SarahAttack(MainCharacter newPastor, Monster mon, int count) {
