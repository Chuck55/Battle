...
public class JayBattle implements BattleBase {
    ...
    public boolean Jayfight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void JayAttack(MainCharacter newPastor, Monster mon) {
