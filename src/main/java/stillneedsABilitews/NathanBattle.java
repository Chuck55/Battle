...
public class NathanBattle implements BattleBase {
    ...
    public boolean Nathanfight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void NathanAttack(MainCharacter newPastor, Monster mon) {
