...
public class IrisBattle implements BattleBase {
    ...
    public boolean Irisfight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void IrisAttack(MainCharacter newPastor, Monster mon, int count) {
