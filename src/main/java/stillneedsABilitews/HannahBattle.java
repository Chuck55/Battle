...
public class HannahBattle implements BattleBase {
    ...
    public boolean Hannahfight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void HannahAttack(MainCharacter newPastor, Monster mon, int count) {
