package BattleStuff;
//Attack becomes 1.5 every 1.5 turn
...
public class AndrewBattle implements BattleBase {
    ...
    public boolean Andrewfight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void AndrewAttack(MainCharacter newPastor, Monster mon, int count) {
        int totalDamage;
        if (count % 2 == 1) {
            System.out.println("Andrew gets a buff! Attack becomes 1.5 times");
        ...
        if (x < mon.getCritChance()) {
            System.out.println("Andrew  : Look at that skill! (hits a crit!)");
