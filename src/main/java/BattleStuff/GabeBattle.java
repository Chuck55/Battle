...
public class GabeBattle implements BattleBase {
    int count = 0;
    ...
    public boolean Gabefight(MainCharacter newPastor, Monster monster, ParentVariable defeated) {
    ...
    public void GabeAttack(MainCharacter newPastor, Monster mon) {
