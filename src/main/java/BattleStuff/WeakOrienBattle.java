        ...
        while (newPastor.getHealth() > 0 && monster.getTotalHealth() > 0) {
            ...
            switch (counter) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    System.out.println("Orien : Now, you can also equip a weapon during battle. Just press the button 3 and press the number by the item you want to equip. You have a pair of chopsticks right? Try it out!");
                    counter++;
                    break;
                case 3:
